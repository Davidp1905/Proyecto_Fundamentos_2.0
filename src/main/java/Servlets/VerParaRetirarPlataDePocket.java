...
@WebServlet(name = "VerParaRetirarPlataDePocket", urlPatterns = {"/VerParaRetirarPlataDePocket"})
public class VerParaRetirarPlataDePocket extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("retirarPlataPocket.jsp");
