...
@WebServlet(name = "VerParaAgregarPockets", urlPatterns = {"/VerParaAgregarPockets"})
public class VerParaAgregarPockets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("agregarPlataPocket.jsp");
